      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#022e75] via-[#023789] to-[#0343a4] pb-20 pt-12 md:pb-28 md:pt-16 text-white">
        <div className="mx-auto max-w-5xl px-4 text-center md:px-8">
          ...
          <div className="mt-8">
            <a
              href="#courses"
              className="inline-block rounded-xl bg-[#0066ff] px-8 py-3.5 text-base font-bold text-white shadow-lg transition-all hover:bg-blue-600 active:scale-[0.98]"
            >
              Explore Courses
            </a>
          </div>
        ...
        <div className="mx-auto max-w-6xl px-4 md:px-8">
          <div className="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
            ...
            <div className="max-w-md space-y-4">
              ...
              <a
                href="#courses"
                className="inline-block rounded-lg bg-[#0066ff] px-6 py-2.5 text-sm font-bold text-white shadow-sm hover:bg-blue-600"
              >
                Learn More
              </a>
            </div>
          ...
          <div className="mt-12 grid grid-cols-1 gap-8 lg:grid-cols-12 lg:items-center">
            ...
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:col-span-7">
              <div className="rounded-2xl border border-blue-100 bg-[#eaf2ff] p-6 shadow-sm">
              ...
              >
                ...
                <div className="flex flex-1 flex-col justify-between p-6">
                  ...
                  <div className="mt-6 pt-4 border-t border-slate-100">
                    <Link
                      href="/register"
                      className="block w-full rounded-lg border border-[#0066ff] py-2 text-center text-xs font-bold text-[#0066ff] hover:bg-[#0066ff] hover:text-white transition-colors"
                    >
                      View Course
                    </Link>
                  </div>
